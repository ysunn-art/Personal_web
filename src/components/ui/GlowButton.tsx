...
export function GlowButton({ children, onClick, href, variant = 'primary', className = '' }: Props) {
  ...
  const styles =
    variant === 'primary'
      ? 'bg-accent text-white font-bold hover:shadow-[0_0_30px_rgba(107,143,163,0.4)]'
      : 'border border-accent text-accent hover:bg-accent/10 hover:shadow-[0_0_20px_rgba(107,143,163,0.3)]'
